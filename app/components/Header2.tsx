...
const Motto = () => {
  return (
    <div className="flex flex-col pt-[80px] w-full h-fit bg-[#F5F5F5] bg-opacity-80 justify-center items-center">
      <div className="flex flex-row justify-center items-center xl:gap-x-[500px] sm:gap-x-[160px] md:gap-x-[200px] lg:gap-x-[380px] xl:px-[70px] sm:px-[10px] pb-[40px]">
        ...
        <div className="flex flex-col relative right-10 xl:pb-[40px] w-full md:w-[45%]">
          <motion.p
            className="relative xl:w-[550px] sm:w-[300px] md:w-[330px] lg:w-[330px] text-[#9F9F9F] font-medium xl:text-[28px] sm:text-[16px] md:text-[18px] lg:text-[20px] h-[220px] lg:top-[30px] sm:top-[40px] text-opacity-85 leading-tight"
